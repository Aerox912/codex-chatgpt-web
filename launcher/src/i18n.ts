...
const ja: Record<keyof typeof en, string> = {
  ...
  biggerContextRecommendationBody: "Bigger Context は最近のビルドで十分にテストされており、ChatGPT Web で最大 3 倍のコンテキストを使用できます。試験的な機能のため、問題が発生した場合は設定から再び無効にできます。",
