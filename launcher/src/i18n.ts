...
const en = {
  ...
  updateCheckBody: "The launcher checks automatically every six hours.",
  checkNow: "Check now",
  checkingForUpdates: "Checking for updates…",
  upToDate: "Codex Web GPT is up to date.",
  updateReady: "Ready to install from the sidebar",
  updatesUnavailable: "Update checks are available in installed builds.",
  workspace: "Workspace",
...
const zh: Record<keyof typeof en, string> = {
  ...
  updateCheckBody: "启动器每六小时自动检查一次更新。",
  checkNow: "立即检查",
  checkingForUpdates: "正在检查更新…",
  upToDate: "Codex Web GPT 已是最新版本。",
  updateReady: "更新已准备好，可从侧边栏安装",
  updatesUnavailable: "更新检查仅适用于已安装的应用。",
  workspace: "工作区",
  configuration: "配置",
  runtime: "运行时",
  browser: "浏览器",
...
const ja: Record<keyof typeof en, string> = {
  ...
  updating: "アップデート中…",
  softwareUpdates: "ソフトウェアアップデート",
  updateCheckBody: "ランチャーは6時間ごとに自動でアップデートを確認します。",
  checkNow: "今すぐ確認",
  checkingForUpdates: "アップデートを確認中…",
  upToDate: "Codex Web GPT は最新です。",
  updateReady: "サイドバーからインストールできます",
  updatesUnavailable: "アップデートの確認はインストール済みビルドで利用できます。",
  workspace: "ワークスペース",
  configuration: "構成",
  runtime: "ランタイム",
  browser: "ブラウザー",
...
const ko: Record<keyof typeof en, string> = {
  ...
  updateCheckBody: "런처가 6시간마다 자동으로 업데이트를 확인합니다.",
  checkNow: "지금 확인",
  checkingForUpdates: "업데이트 확인 중…",
  upToDate: "Codex Web GPT가 최신 버전입니다.",
  updateReady: "사이드바에서 설치할 수 있습니다",
  updatesUnavailable: "설치된 빌드에서 업데이트를 확인할 수 있습니다.",
  product: "Codex Web GPT",
  devBadge: "DEV",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  updateCheckBody: "啟動器每六小時自動檢查更新。",
  checkNow: "立即檢查",
  checkingForUpdates: "正在檢查更新…",
  upToDate: "Codex Web GPT 已是最新版本。",
  updateReady: "可從側邊欄安裝",
  updatesUnavailable: "已安裝的版本可檢查更新。",
  product: "Codex Web GPT",
  devBadge: "DEV",
