...
test("checksums and release URLs bind the exact expected asset", () => {
  ...
  assert.equal(
    validateReleaseAssetUrl(
      "https://github.com/Aerox912/codex-chatgpt-web/releases/download/v1.2.0/launcher.zip",
      "1.2.0",
      "launcher.zip",
    ),
    "https://github.com/Aerox912/codex-chatgpt-web/releases/download/v1.2.0/launcher.zip",
        ...
        dependencies: {
          fetchRelease: async () => ({
            ...
            assets: [`codex-web-gpt-${tag}-linux-x64.AppImage`, "checksums.txt"].map(name => ({
              name,
              browser_download_url: `https://github.com/Aerox912/codex-chatgpt-web/releases/download/v${tag}/${name}`,
            })),
          }),
        },
      });
            ...
            assets: [
              {
                ...
                browser_download_url: `https://github.com/Aerox912/codex-chatgpt-web/releases/download/v1.2.0/codex-web-gpt-1.2.0-linux-${arch}.AppImage`,
              },
              {
                name: "checksums.txt",
                browser_download_url: "https://github.com/Aerox912/codex-chatgpt-web/releases/download/v1.2.0/checksums.txt",
