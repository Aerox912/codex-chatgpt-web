...
const expected = [
  ...
  [".github/workflows/ci.yml", "prepare-fork-bun-runtime.ps1"],
  [".github/workflows/release.yml", `Bun-${bunVersion}.md`],
  [".github/workflows/release.yml", "prepare-fork-bun-runtime.ps1"],
  ["scripts/prepare-fork-bun-runtime.ps1", "1.4.0+34cbb9a40"],
] as const;
...
for (const path of ["README.md", "README.zh-CN.md", "README.ja.md", "README.ko.md"]) {
  ...
  for (const target of ["win-x64.exe", "linux-x64.AppImage"]) {
