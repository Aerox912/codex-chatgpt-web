...
<p align="center">
  <a href="https://github.com/Aerox912/codex-chatgpt-web/releases/download/v6.0.0-alpha.1/codex-web-gpt-6.0.0-alpha.1-win-x64.exe"><img src="assets/readme/download-windows.svg" width="224" height="64" alt="Windows · x64"></a>&nbsp;
  ...
  <a href="https://github.com/Aerox912/codex-chatgpt-web/releases/download/v6.0.0-alpha.1/codex-web-gpt-6.0.0-alpha.1-linux-x64.AppImage"><img src="assets/readme/download-linux.svg" width="224" height="64" alt="Linux · x64"></a>
</p>

<p align="center">
  Fork releases provide Windows and Linux assets. macOS links below point to the original upstream release.
  <a href="https://github.com/miuuyy/codex-chatgpt-web/releases/download/v6.0.0/codex-web-gpt-6.0.0-mac-x64.dmg">macOS Intel</a> · <a href="https://github.com/miuuyy/codex-chatgpt-web/releases/latest">모든 릴리스</a>
</p>
...
```powershell
irm https://github.com/Aerox912/codex-chatgpt-web/releases/latest/download/install-launcher.ps1 | iex
```
