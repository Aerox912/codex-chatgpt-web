...
Experimental Bigger Context stages and their final commit remain inline protocol messages and obey
their measured per-message transport limits; they never use the native pasted-text attachment path.
